  ...
  <SecondaryLayout>
    ...
    <section purple id="pah-symptoms">
      ...
      <div class="section-body">
        ...
        <p>
          Early on, you may notice these symptoms of PAH during physical
          activity. As the disease progresses, symptoms can happen even at rest.
        </p>
      </div>
    ...
    <section purple id="pah-diagnosis">
      ...
      <h1 class="section-header">PAH Diagnosis</h1>
      ...
      <div class="section-body">
        ...
        <p>
          ...
          perform a <strong>right-heart catheterization (RHC)</strong> to
          measure the pressures in your heart and the arteries in your lungs. A
          RHC also measures how much blood your heart pumps through your lungs
          and the resistance in the blood vessels in your lungs. It is not only
          an important measure of how severe your PAH is, but also helps guide
          treatment decisions, and helps identify other issues that may be
          adding to your symptoms.
        </p>
      </div>
    </section>
    <!-- pah-diagnosis -->
