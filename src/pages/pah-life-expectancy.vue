  ...
  <SecondaryLayout>
    <section purple id="managing-your-pah">
      <g-image
        ...
        alt="an icon of a speedometer"
      />
      <h1 class="section-header">
        Managing Your PAH and Impact on Life Expectancy
      </h1>
    ...
    <section grey id="risk-prognosis">
      ...
      <div class="section-body">
        <p>
          ...
          <strong
            >The goal is to improve your risk status today to lower the chance
            of your disease getting worse in the future.</strong
          >
        </p>
      </div>
    </section>
    ...
    <section grey id="find-a-specialist">
      ...
      <div class="section-body">
        <p>
          Because PAH is a rare disease, not all heart and lung specialists in
          your community have expertise treating it. For this reason,
          <strong
    ...
    <section grey id="build-your-network">
      ...
      <div class="section-body">
        ...
        <ul>
          <li>A care nurse experienced with PAH</li>
          <li>Your Specialty Pharmacy</li>
          <li>
            Family and friends tasked with specific aspects of caregiving and
            support
          </li>
          <li>PAH Support Group</li>
          <li>
            Other patients you can connect with via Patient-to-Patient Support
            Lines, email or phone
          </li>
        </ul>
    ...
    <section purple id="on-your-own">
      ...
      <div class="section-body">
        <p>
          There may not be a cure for PAH today, but there are ways to manage
          your condition. Making some small lifestyle changes can go a long way
          toward helping you feel better. Ask your doctor about:
        </p>

        <ul>
          <li>Eating a balanced, healthy diet</li>
          <li>Minimizing your salt intake</li>
          <li>Staying active with a doctor-approved exercise program</li>
          <li>Weighing yourself regularly and reporting to your doctor</li>
...
#treatment-goals .section-header {
  @include for-desktop-up {
